    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5 style="color: #6F75FF">[{{ $pt->kode_pt }}] - {{ $pt->nama_pt }}</h5>
                <form id="editForm{{ $pt->kode_pt }}"
                    ...
                    <div class="card"
                        ...
                        <div class="card-body">
                            <h5>Pimpinan Perguruan Tinggi</h5>
                            <hr style="border: 0; border-top: 1px solid #c7c7c7;">
                            <div class="text-nowrap">
                                <div class="row form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="pimpinan" class="form-label"><b>Pimpinan Perguruan
                                                    Tinggi</b></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="hp_pimpinan"
                                                id="hp_pimpinan" placeholder="HP Pimpinan PT"
                                                value="{{ $pt->hp_pimpinan }}">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-nowrap">
                                <div class="row form-row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <label for="nama_pt" class="form-label"><b>Nama Perguruan
                                                    Tinggi</b></label>
                                ...
                                <div class="row form-row">
                                    <div class="form-group">
                                        <label for="nama_pt_singkatan" class="form-label"><b>Nama PT
                                                Singkatan</b></label>
                                ...
                                <div class="row form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="nama_kota_kab" class="form-label"><b>Nama
                                                    Kota/Kabupaten</b></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kode_pos"
                                                id="kode_pos" placeholder="Kode Pos" value="{{ $pt->kode_pos }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="status_pt" class="form-label"><b>Status Perguruan
                                                    Tinggi</b></label>
                                            <select class="form-select" name="status_pt"
                                                id="status_pt{{ $pt->status_pt }}">
                                                <option value="A"
                                                    @if ($pt->status_pt == 'A') selected @endif>
                                                    Aktif</option>
                                                <option value="B"
                                                    @if ($pt->status_pt == 'B') selected @endif>Alih
                                                    Bentuk</option>
                                                <option value="N"
                                                    @if ($pt->status_pt == 'N') selected @endif>Non
                                                    Aktif</option>
                                                <option value="M"
                                                    @if ($pt->status_pt == 'M') selected @endif>
                                                    Merge</option>
                                                <option value="H"
                                                    @if ($pt->status_pt == 'H') selected @endif>
                                                    Hapus</option>
                                                <option value="K"
                                                    @if ($pt->status_pt == 'K') selected @endif>Alih
                                                    Kelola</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="status_aipt"
                                                ...
                                                <option value="Belum Terakreditasi (Y)"
                                                    @if ($pt->status_aipt == 'Belum Terakreditasi (Y)') selected @endif>Belum
                                                    Terakreditasi
                                                    (Sudah
                                                    upload Sapto)</option>
                                                <option value="Belum Terakreditasi (N)"
                                                    @if ($pt->status_aipt == 'Belum Terakreditasi (N)') selected @endif>Belum
                                                    Terakreditasi
                                                    (Belum
                                                    upload Sapto)</option>
                    ...
                    <div class="card"
                        style="border-top: 5px solid #6F75FF; border-right: 1px solid #c7c7c7; 
                                                border-bottom: 1px solid #c7c7c7; border-left: 1px solid #c7c7c7;">
                        <div class="card-body">
                            <h5>Data Akreditasi Perguruan Tinggi</h5>
                            <hr style="border: 0; border-top: 1px solid #c7c7c7;">
                            <div class="text-nowrap">
                                <div class="row form-row">
                                    <div class="form-group">
                                ...
                                <div class="row form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="peringkat_aipt" class="form-label"><b>Peringkat
                                                    APT</b></label>
                                            <select class="form-select" name="peringkat_aipt"
                                                id="peringkat_aipt{{ $pt->kode_pt }}">
                                                <option value="">--Pilih Peringkat APT--</option>
                                                <option value="-"
                                                    @if ($pt->peringkat_aipt == '-') selected @endif>
                                                    Tidak
                                                    Terakreditasi</option>
                                                <option value="A"
                                                    @if ($pt->peringkat_aipt == 'A') selected @endif>
                                                    Terakreditasi A</option>
                                                <option value="B"
                                                    @if ($pt->peringkat_aipt == 'B') selected @endif>
                                                    Terakreditasi B</option>
                                                <option value="Baik"
                                                    @if ($pt->peringkat_aipt == 'Baik') selected @endif>
                                                    Terakreditasi Baik</option>
                                                <option value="BS"
                                                    @if ($pt->peringkat_aipt == 'BS') selected @endif>
                                                    Terakreditasi Baik Sekali</option>
                                                <option value="Unggul"
                                                    @if ($pt->peringkat_aipt == 'Unggul') selected @endif>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nilai_aipt"
                                                id="nilai_aipt" placeholder="Nilai APT"
                                                value="{{ $pt->nilai_aipt }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="tgl_sk_aipt"
                                                id="tgl_sk_aipt"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="tgl_kadaluarsa_aipt" class="form-label"><b>Tanggal Kadaluarsa
                                                    SK
                                                    APT</b></label>
