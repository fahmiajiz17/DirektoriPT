...
@section('content')
    ...
    <div class="faq-header d-flex flex-column justify-content-center align-items-center h-px-300 position-relative overflow-hidden rounded-4">
        ...
        <h4 class="text-center text-primary mb-2">Halo, ada yang bisa kami bantu?</h4>
        <p class="text-body text-center mb-0 px-4">atau pilih kategori untuk menemukan bantuan yang Anda perlukan dengan cepat</p>
        <div class="input-wrapper mb-6 mt-7 input-group input-group-merge px-sm-5">
            ...
            <input type="text" class="form-control" placeholder="Berikan pertanyaan...." aria-label="Search"
            ...
            <div class="d-flex justify-content-between flex-column nav-align-left mb-2 mb-md-0">
                ...
                <div class="d-none d-md-block">
                    <div class="mt-4 text-center">
                        <img src="../../assets/img/illustrations/faq-illustration.png" class="img-fluid" width="135"
                            alt="FAQ Image" />
                    </div>
                </div>
            </div>
    ...
    <div class="row my-6">
        <div class="col-12 text-center my-6">
            <div class="badge bg-label-primary rounded-pill">Pertanyaan?</div>
            <h4 class="my-2">Anda masih punya pertanyaan?</h4>
            <p class="mb-0">
                Jika Anda tidak dapat menemukan pertanyaan di FAQ kami, Anda dapat menghubungi kami. Kami akan segera menjawab Anda!
            </p>
        </div>
    </div>
    <div class="row justify-content-center gap-sm-0 gap-6">
        <div class="col-sm-6">
            <div class="p-6 rounded-4 bg-faq-section d-flex align-items-center flex-column">
                ...
                <h5 class="mt-4 mb-1"><a class="text-heading" href="tel:+(62)2244121226">+ (62) 8224-4121-226</a></h5>
                <p class="mb-0">Kami selalu dengan senang hati membantu</p>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="p-6 rounded-4 bg-faq-section d-flex align-items-center flex-column">
                ...
                <h5 class="mt-4 mb-1"><a class="text-heading" href="mailto:informasi@lldikti4.id">informasi@lldikti4.id</a></h5>
